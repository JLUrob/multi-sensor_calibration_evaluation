...
# path = '../results/camera2camera/datasets1/distance.txt'
# path = '../results/camera2camera/datasets2/distance.txt'
# path = '../results/camera2camera/datasets3/distance.txt'
...
plt.title("distance_error", fontproperties = font_S)
# plt.plot(x, y)
plt.tight_layout()
# plt.legend(loc = "best")
