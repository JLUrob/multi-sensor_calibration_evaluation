...
# path = '../results/camera2camera/datasets1/reproject.txt'
# path = '../results/camera2camera/datasets2/reproject.txt'
# path = '../results/camera2camera/datasets3/reproject.txt'
...
plt.title("reproject_error", fontproperties = font_S)
# plt.plot(x, y)
plt.tight_layout()
# plt.legend(loc = "best")
