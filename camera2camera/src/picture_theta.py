...
# path = '../results/camera2camera/datasets1/theta.txt'
# path = '../results/camera2camera/datasets2/theta.txt'
# path = '../results/camera2camera/datasets3/theta.txt'
...
plt.title("theta_error", fontproperties = font_S)
# plt.plot(x, y)
plt.tight_layout()
# plt.legend(loc = "best")
