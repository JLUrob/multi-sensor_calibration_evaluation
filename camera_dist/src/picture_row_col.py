...
path_v1 = '../results/camera_dist/datasets1/pre_dist_row_col.txt'
path_v2 = '../results/camera_dist/datasets1/removed_dist_row_col.txt'
...
plt.plot(x, y_v1,'s-', c='g', label="pre")
plt.scatter(x, y_v1, c='g')

plt.plot(x, y_v2, 'o-',c='r', label="after")
...
plt.ylabel("variance", fontproperties = font_M)
plt.title("row_col_dist_evaluate", fontproperties = font_S)
# plt.plot(x, y)
plt.tight_layout()
plt.legend(loc = "best")
plt.savefig("../results/camera_dist/datasets1/result_row_col.jpg")
plt.show()
