...
path_v1 = '../results/camera_dist/datasets1/pre_dist_all.txt'
path_v2 = '../results/camera_dist/datasets1/removed_dist_all.txt'
...
plt.title("all_dist_evaluate", fontproperties = font_S)
# plt.plot(x, y)
plt.tight_layout()
plt.legend(loc = "best")
plt.savefig("../results/camera_dist/datasets1/result_all.jpg")
plt.show()
