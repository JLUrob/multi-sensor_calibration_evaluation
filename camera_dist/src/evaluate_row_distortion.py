...
if __name__ == '__main__':
    ...
    np.savetxt(f"../results/camera_dist/datasets1/pre_dist_row.txt", v1)
    np.savetxt(f"../results/camera_dist/datasets1/removed_dist_row.txt", v2)
